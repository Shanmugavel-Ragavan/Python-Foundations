...
# Using 'and' operator: True only if both conditions are True
print("a >= 10 and a <= 20:", a >= 10 and a <= 20)  # False

# Using 'or' operator: True if at least one condition is True
print("a >= 10 or a <= 20:", a >= 10 or a <= 20)    # True

# Using 'not' operator: Inverts the result of a condition
print("not(a >= 10 and a <= 20):", not(a >= 10 and a <= 20))  # True